...
def index():
	...
	return render_template('index.html',form = form, num_tweets = num_of_tweet_so_far) # TODO 364: Add more arguments to the render_template invocation to send data to index.html
